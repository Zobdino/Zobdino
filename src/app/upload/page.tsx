  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-20">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-zinc-600 dark:text-zinc-300">فایل خود را به خلاصه فارسی ساختاریافته، پادکست خلاصه یا روایت کامل تبدیل کنید. در این مرحله، TXT و Markdown به‌صورت امن در مرورگر آماده می‌شوند.</p>
      </div>
      <UserFileIngestion />
    </div>
  );
