      ...
      <section className="mb-10 grid gap-7 lg:grid-cols-[1fr_360px] lg:items-end">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-4xl font-black leading-tight tracking-tight md:text-6xl">
            کتاب بعدی‌ات را برای فهمیدن انتخاب کن.
          </h1>
        ...
        <div className="z-surface grid gap-3 p-4 sm:grid-cols-3 lg:grid-cols-1">
          {[
            ...
            return (
              <div key={String(title)} className="flex items-center gap-3 rounded-2xl border border-black/7 bg-white/60 p-3 dark:border-white/8 dark:bg-white/[0.025]">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs z-muted">{String(description)}</p>
                </div>
              </div>
            );
          })}
